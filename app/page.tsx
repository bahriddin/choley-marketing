  ...
  return (
    <div className="min-h-[1024px] bg-white">
      ...
      <div className="relative h-[600px] w-full overflow-hidden">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-r from-blue-950/80 via-indigo-950/50 to-gray-900/10"></div>
        </div>
      ...
      {/* How It Works */}
      <div className="bg-gradient-to-r from-blue-950 via-indigo-950 to-gray-900 py-24 text-white">
        <div className="mx-auto max-w-7xl px-6">
              ...
              <div key={index} className="text-center">
                <div className="mb-6">
                  <div className="mx-auto h-16 w-16 rounded-full bg-blue-50 flex items-center justify-center">
                    <i className={`${step.icon} text-2xl text-blue-950`}></i>
                  </div>
                </div>
